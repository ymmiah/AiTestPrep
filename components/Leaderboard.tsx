        ...
        <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800">
            <div className="max-w-3xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 mt-1">See how you rank among other learners!</p>
                </div>
                ...
                <div className="space-y-3">
                    {leaderboard.map((entry) => (
                        ...
                        >
                            <div className="flex items-center w-12 font-bold text-lg text-slate-500 dark:text-slate-400">
                            ...
                            <div className="flex items-center flex-1">
                                ...
                                />
                                <span className={`font-medium ${entry.isCurrentUser ? 'text-indigo-800 dark:text-indigo-200' : 'text-slate-800 dark:text-slate-100'}`}>{entry.name}</span>
                            </div>
